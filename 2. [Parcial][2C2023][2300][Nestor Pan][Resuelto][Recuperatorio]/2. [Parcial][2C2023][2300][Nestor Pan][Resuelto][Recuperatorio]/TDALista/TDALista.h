...
/**
 * Nota: Si el llamado a alguna/s de estas primitivas, le da el error "Undefined reference ...", significa que dicha primitiva no está implementada, por lo tanto no se utilizó en la resolución del parcial.
 * De todas formas, en caso de corresponder, puede implementar su propia versión de la/s primitiva/s.
**/
...
bool listaIteradorFinIteracion(ListaIterador* pli);
